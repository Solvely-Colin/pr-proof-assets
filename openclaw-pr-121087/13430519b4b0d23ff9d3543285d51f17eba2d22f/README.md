...
- Reviewed head: `13430519b4b0d23ff9d3543285d51f17eba2d22f`
...
The media was retained across the conflict-resolution rebase because the resolved production
text-scaling rules and demonstrated interaction are unchanged. The rewritten head adds the
production viewport metadata to the mobile regression fixture and incorporates current-main
cursor-policy changes; focused exact-head browser tests and the production build revalidated the
shown behavior.
