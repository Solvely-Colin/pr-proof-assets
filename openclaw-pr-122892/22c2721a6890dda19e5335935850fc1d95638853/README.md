...
- Exact head: `22c2721a6890dda19e5335935850fc1d95638853`
...
- `after.png`: reviewed product UI from commit `820ce56a6ef20096a29150a05cef4c8fec962832`. The exact PR head only adds polling to the corresponding desktop/mobile containment assertions; product output is unchanged.
