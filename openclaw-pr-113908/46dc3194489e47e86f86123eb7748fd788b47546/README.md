...
- `process-death.mp4`: diagnostic process-restart attempt; included for transparency, not used as affirmative restoration proof.
...
- A forced cold start opened Overview instead of restoring the previously selected Chat destination; no stronger process-restoration claim is made.
